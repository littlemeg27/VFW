...
//11/11/2012
    ...
    window.addEventListener("DOMContentLoaded", function()
    {
        ...
        { 
                ...
                editLink = document.createElement("a"); //add edit single item link
                editLink.href = "#";
                editLink.key = key;
        ...
        function editItem()//grabs the data from our item from local storage 
        {
            ...
            for(var i=0; i<radios.length; i++)
            {
                ...
                if (item.trimValue[1] == "Yes")
                {
                    $("trim").setAttribute("checked", "checked");
                }
                
            $('dogName').value = item.dogName[1];
            $('groups').value = item.dogBreed[1];
            $('date').value = item.date[1];
            $('comments').value = item.comments[1];
            $('slide').value = item.slidex[1];
        ...
        { 
            ...
            {
                var phoneNumberError = "Please enter a phone number";
